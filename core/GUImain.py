...
class App:
    ...
    def __init__(self):
        ...
        col1 = sg.Column([
                    ...
                    [sg.Canvas(size=(500, 500), key="canvas", background_color="green")],
        ...
        col2 = sg.Frame('results',[
                       [sg.Image(filename='', key='image1', size=(200,100),background_color="grey"), sg.Button('view', size=(6,1)), sg.Button('close', size=(6,1))],
                       [sg.Image(filename='', key='image2', size=(200,100),background_color="grey"), sg.Button('view', size=(6,1)), sg.Button('close', size=(6,1))],
                       [sg.Image(filename='', key='image3', size=(200,100),background_color="grey"), sg.Button('view', size=(6,1)), sg.Button('close', size=(6,1))],
                       [sg.Image(filename='', key='image4', size=(200,100),background_color="grey"), sg.Button('view', size=(6,1)), sg.Button('close', size=(6,1))],
                       [sg.Image(filename='', key='image5', size=(200,100),background_color="grey"), sg.Button('view', size=(6,1)), sg.Button('close', size=(6,1))],
                   ])
        layout = [[col1, col2]]
        #
        # layout = [[sg.Menu(menu_def)],
        #           sg.Column([[sg.Text('Select video')], [sg.Input(key="_FILEPATH_"), sg.Button("Browse")],
        #           [sg.Canvas(size=(500, 500), key="canvas", background_color="green")],
        #           [sg.Slider(size=(30, 20), range=(0, 100), resolution=100, key="slider", orientation="h",
        #                      enable_events=True), sg.T("0", key="counter", size=(10, 1))],
        #           [sg.Button('Next frame'), sg.Button("Pause", key="Play"), sg.Button('Exit')]]),
        #           sg.Column([[sg.T('asdfas')]])]

        self.window = sg.Window('AI View', layout).Finalize()
        ...
        while True:  # Main event Loop
            ...
            if event == "Play":
                ...
                self.window['Play'].update(('play', 'pause')[self.play], button_color=(('white',('green', 'red')[self.play])))
